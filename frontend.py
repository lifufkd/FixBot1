...
class Bot_inline_btns:
    ...
    def start_buttons(self):
        first = types.InlineKeyboardButton('Авторизоваться', url="https://api.notion.com/v1/oauth/authorize?client_id=615dba0d-2dcd-4e9d-b6c5-d543f495984d&response_type=code&owner=user&redirect_uri=https://t.me/wfwfwegwvwefbot/?start=")
